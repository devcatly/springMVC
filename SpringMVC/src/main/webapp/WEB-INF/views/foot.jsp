				...
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-md-12 hidden-xs text-right">
							<a href="#"><i class="fa fa-3x fa-fw text-info fa-apple"></i></a>
							<a href="#"><i class="fa fa-3x fa-fw text-warning fa-cc"></i></a>
							<a href="#"><i class="fa fa-3x fa-bell fa-fw text-danger"></i></a>
